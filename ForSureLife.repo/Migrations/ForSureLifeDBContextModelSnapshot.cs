...
namespace ForSureLife.repo.Migrations
{
    ...
    partial class ForSureLifeDBContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ForSureLife.repo.Application", b =>
                {
                    ...
                    b.Property<Guid?>("DesigneeId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<DateTime>("ExpirationDate")
                        .HasColumnType("datetime2");

                    b.Property<bool>("ImmediateLeadCaptured")
                        .HasColumnType("bit");

                    b.Property<bool>("ImmediateLeadEmailed")
                        .HasColumnType("bit");

                    b.Property<bool>("ImmediateLeadSendToIntegrity")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("OmniSendContactId")
                        .HasColumnType("nvarchar(max)");

                    b.Property<Guid?>("PaymentInfoPaymentId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<bool>("QuoteLeadEmailed")
                        .HasColumnType("bit");

                    b.Property<bool>("SaleCaputured")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("ForSureLife.repo.Models.Quote.Designee", b =>
                {
                    b.Property<Guid>("DesigneeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ForSureLife.repo.PaymentInfo", b =>
                {
                    ...
                    b.Property<string>("CreditCardRef")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ForSureLife.repo.Application", b =>
                {
                    ...
                    b.HasOne("ForSureLife.repo.Models.Quote.Designee", "Designee")
                        .WithMany()
